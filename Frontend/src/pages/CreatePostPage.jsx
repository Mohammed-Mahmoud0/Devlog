    ...
    >
      ...
      <div>
        ...
        <Input
          ...
          className="border-2 border-[#141624] dark:border-[#3B3C4A] focus:outline-0 h-10 w-100 max-sm:w-75 max-sm:text-[14px]"
        />
      ...
      <div>
        ...
        <Textarea
          ...
          className="border-2 border-[#141624] dark:border-[#3B3C4A] focus:outline-0 h-45  w-100 text-justify max-sm:w-75 max-sm:text-[14px]"
        />
      ...
      <div className="w-full">
        ...
        >
          <SelectTrigger className="border-2 border-[#141624] dark:border-[#3B3C4A] focus:outline-0 h-10 w-full max-sm:w-75 max-sm:text-[14px]">
