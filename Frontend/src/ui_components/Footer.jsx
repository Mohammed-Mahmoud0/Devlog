  ...
  return (
    <footer className="bg-[#F6F6F7] padding-x py-16 max-container dark:bg-[#141624]">
      <div className="flex max-lg:gap-9 lg:gap-4 flex-wrap max-md:justify-center justify-between">
        <div className="w-75 flex flex-col gap-6 max-md:items-center">
          <h1 className="text-[#141624] text-2xl dark:text-[#FFFFFF] ">
            Devlog
          </h1>

          <p className="text-[14px] text-[#696A75] leading-normal  max-md:text-center dark:text-[#97989F]">
        ...
        <div className="bg-white w-87.5 px-6 flex flex-col items-center justify-center gap-2  rounded-lg dark:bg-[#242535] py-6">
          ...
          <div className="w-full relative">
            <input
              ...
              className="border border-[#DCDDDF] rounded-sm h-10 px-3 py-3 w-full text-[14px] dark:bg-[#181A2A] "
            />
            <CiMail className="absolute top-3 right-2.5 text-[16px] dark:text-[#97989F]" />
          </div>
